...
const CreateSiteForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Navigate to /site/:id with the created site's ID
        navigate(`/site/${data.site.siteId}`);
      } else {
  ...
  const inputClass =
    "mt-2 block w-full rounded-lg border border-gray-200 px-4 py-3 text-gray-700 transition-all duration-200 ease-in-out focus:border-[#FD7149] focus:ring-2 focus:ring-[#FD7149] focus:ring-opacity-20 hover:border-[#FD7149]";
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">
              Fill in the details to create your new website
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="space-y-4">
                <div>
                  <label htmlFor="metadataDescription" className={labelClass}>
                    Meta Description
                  </label>
                  <textarea
                ...
                <div>
                  <label htmlFor="metadataUrl" className={labelClass}>
                    Site URL
                  </label>
                  <input
                    type="url"
                ...
                <div>
                  <label htmlFor="metadataLogo" className={labelClass}>
                    Logo URL
                  </label>
                  <input
                    type="url"
